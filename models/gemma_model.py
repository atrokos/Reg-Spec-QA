...
class GemmaModel(BaseModel):
    def __init__(
        ...
        language = (
            "Czech"
            if lang_flag == "CS"
            else "English" if lang_flag == "EN" else "Ukrainian" if lang_flag == "UK" else "Unknown"
        )
    ...
    def generate(
        self, input_tuple: tuple[str, str], input_type: Literal["url", "url_agent", "file"] = "url_agent"
    ) -> str:
